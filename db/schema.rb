...
ActiveRecord::Schema.define(version: 20180927204528) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "availability_table", force: :cascade do |t|
    t.datetime "time"
    t.integer  "user_id"
    t.index ["user_id"], name: "index_availability_table_on_user_id", using: :btree
  end
